...
{  /**
    * Holds the dimensions of the layout size 
    * @param parent
    * @return Dimension(left + GAP + right, height)
    */
    ...
    /**
     * Add layout component, empty for this case
     * @param name
     * @param comp 
     */
    ...
    /**
     * Remove layout component, empty for this case
     * @param comp 
     */
